...
// Function to insert a new node at any position in the double linked list
...
void display(struct Node* head)
{
    ...
    // Print the double linked list in forward direction
    struct Node* current = head;
    ...
    // Print the double linked list in reverse direction
    current = head;
